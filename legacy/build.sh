...
# MODIFIED: Point to the PNG in the parent directory
...
# Links ServiceManagement for the legacy SMLoginItemSetEnabled function.
...
<plist version="1.0"><dict>
  ...
  <key>CFBundleVersion</key>     <string>1.0-legacy</string>
  <key>CFBundleShortVersionString</key> <string>1.0-legacy</string>
...
echo "✅  $APP (Monterey Legacy) built successfully in 'legacy/' directory."
